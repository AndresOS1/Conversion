...
@section('content') 
        ...
        <div class="w-75 d-flex justify-content-center flex-column">
            ...
            <form action="{{-- {{route('pais.store')}} --}}" class="d-flex flex-column w-75 m-auto mt-5 gap-5 " method="POST">
                ...
                <div class="w-100 d-flex  flex-column justify-content-center aligin-items-center">
                    <input type="text" class="form-control w-75 m-auto rounded-5" placeholder="ingresa el pais" name="nombre_pais">
                ...
                <div class="w-100 d-flex  flex-column justify-content-center aligin-items-center rounded-5">
                    <select type="text" class="form-select w-75 m-auto rounded-5" placeholder="ingresa el pais" name="moneda_id">
